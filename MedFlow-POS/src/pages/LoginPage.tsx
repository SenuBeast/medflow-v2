        ...
        <div className="flex items-center justify-center h-screen w-screen bg-pos-bg text-pos-text">
            <div className="w-full max-w-md p-8 bg-pos-surface border border-pos-border relative">
                ...
                <div className="flex justify-center mb-8">
                    <h1 className="text-2xl font-bold tracking-tight text-pos-text-main">MedFlow POS</h1>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                        ...
                        className="w-full mt-4 bg-blue-600 hover:bg-blue-500 text-white font-bold py-4 px-4 transition-colors uppercase tracking-widest disabled:opacity-50 shadow-lg shadow-blue-600/20"
                    >
