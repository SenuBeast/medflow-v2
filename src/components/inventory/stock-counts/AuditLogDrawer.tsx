...
export function AuditLogDrawer({ sessionId, isOpen, onClose }: AuditLogDrawerProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 overflow-hidden text-sm">
            ...
            {/* Drawer */}
            <div className="fixed inset-y-0 right-0 w-full max-w-md flex flex-col bg-white shadow-xl transform transition-transform duration-300 ease-in-out border-l border-gray-100">
                {/* Header */}
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gray-50/50">
                    <div>
                        <h2 className="text-lg font-bold text-gray-900">Audit Trail</h2>
                        <p className="text-xs text-gray-500">History for session #{sessionId.substring(0, 8)}</p>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto px-6 py-4">
                    {isLoading ? (
                        ...
                        <div className="text-center py-10 text-gray-500">No logs found for this session.</div>
                    ) : (
                                ...
                                return (
                                    <div key={log.id} className="relative pl-6">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <div className="flex items-center gap-2 mt-1 px-3 py-2 bg-gray-50 rounded-lg text-xs text-gray-600">
